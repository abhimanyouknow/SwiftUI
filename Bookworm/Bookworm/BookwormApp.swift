...
/* step 2: loading data model (tells the SwiftData to
 prepare some actual, physical storage on an iPhone to
 save data to, which is where it'll read & write our
 Studnet object */
...
struct BookwormApp: App {
    var body: some Scene {
        ...
        // step 3
        /* setting up model context - which let's us work with all our data in Memory
