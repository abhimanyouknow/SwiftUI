...
//  SnowSeeker
//
//  Created by C3PO MBP on 22/01/25.
//
...
extension Bundle {
    func decode<T: Decodable>(_ file: String) -> T {
        ...
        do {
            ...
            fatalError("Failed to decode \(file) form the bundle due to missing key '\(key)' - \(context.debugDescription)")
            ...
            fatalError("Failed to decode \(file) from the bundle because it appears to be invalid JSON.")
        } catch {
